...
public class NotifyWorker2a extends Worker {
    private static final String PRIMARY_CHANNEL_ID = "primary_notification_channel";
    public SharedPreferences mPreferences5;
    private String sharedPrefFile =    "com.example.android.Plan4Success";


    public NotifyWorker2a(@NonNull Context context, @NonNull WorkerParameters params) {
...
*/
        ...
        int a = mPreferences.getInt("SizeB", 0);

        String description = "";
        for(int i = 0; i<a;i++) {
            if (i != (a - 1)) {
                description = description + mPreferences.getString("Assignment"+i,"") + ", " ;
            }else{
                description = description + mPreferences.getString("Assignment"+i,"");
        ...
        Notification notification = builder
                .setContentTitle("You have " + a + " Assignment(s) left")
